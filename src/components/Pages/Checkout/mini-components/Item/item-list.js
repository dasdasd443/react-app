        ...
        <section className="items-list__item">
                            ...
                            <section className="items-list__item--quantity">
                                <form action="" onSubmit={ e => e.preventDefault()}>
                                    <button className='minus-quantity' onClick={() => dispatch(decrement(id))}><FontAwesomeIcon icon={faMinus}/></button>
                                    <input type="number" name="quantity" className="quantity" min="0" value={quantity} onChange={updateQuantity}/>
                                    <button className='add-quantity' onClick={() => dispatch(increment(id))}><FontAwesomeIcon icon={faPlus}/></button>
                                </form>
                            </section>
